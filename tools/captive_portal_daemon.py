...
if os.geteuid() == 0:
    ...
    if not os.path.exists(_rd):
        _rd = "/tmp"
    LOG_FILE = os.path.join(_rd, "captive_portal_daemon.log")
    PID_FILE = os.path.join(_rd, "captive_portal_daemon.pid")
    COOKIES_FILE = os.path.join(_rd, "captive_portal_cookies.pkl")
