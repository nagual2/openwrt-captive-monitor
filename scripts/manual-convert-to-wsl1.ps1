...
$p3 = Start-Process -FilePath "wsl.exe" -ArgumentList @("--import",$Distro,$Install,$Archive,"--version","1") -PassThru -NoNewWindow
$last3 = 0
...
Write-Host "Done. Imported '$Distro' to WSL1 from $Archive."
