...
## 2.5. Виртуализированное тестирование (QEMU VM)

Подробное руководство по настройке и автоматизации виртуализированного тестирования см. в [Virtualized Testing Guide](guides/virtualized-testing.md).

### Ключевые преимущества
- **Полная эмуляция OpenWrt:** Настоящая сетевая изоляция и firewall
- **Автоматизация в CI:** Интеграция с GitHub Actions
- **Регрессионное тестирование:** Быстрая проверка совместимости
- **Отладка:** Доступ к полной системе через SSH

### Основные сценарии
- Установка и удаление пакета в реальной среде OpenWrt
- Тестирование init-скриптов и UCI конфигурации  
- Валидация firewall правил (iptables/nftables)
- Проверка DNS/HTTP redirects
- Тестирование cleanup процедур

### Интеграция с CI
- Использование QEMU TCG (без nested virtualization)
- Кэширование OpenWrt образов
- Автоматическая генерация отчётов
- Сбор логов и артефактов при ошибках
